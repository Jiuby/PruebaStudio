...
const COLLECTIONS: Collection[] = [
  {
    ...
    image: 'https://picsum.photos/id/445/1200/800', // Denim texture/baggy jeans
    category: 'Bottoms',
    size: 'large'
  },
  {
    ...
    image: 'https://picsum.photos/id/621/800/1000', // Hoodie detail
    category: 'Hoodies',
    size: 'medium'
  },
  {
    ...
    image: 'https://picsum.photos/id/338/800/1000', // Glasses/Accessories
  ...
  },
  {
    ...
    image: 'https://picsum.photos/id/177/1200/600', // Tee graphic
    category: 'Tees',
    size: 'small'
  }
];
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        {COLLECTIONS.map((collection, index) => (
          <motion.div
            ...
            className={`relative group overflow-hidden bg-brand-dark ${
              collection.size === 'large' ? 'md:col-span-2 aspect-[21/9]' : 
              collection.size === 'small' ? 'md:col-span-2 aspect-[21/9]' : 'aspect-[4/5] md:aspect-square'
            }`}
          >
            <Link to={`/shop?category=${collection.category}`} className="block w-full h-full">
              {/* Image */}
              <img 
