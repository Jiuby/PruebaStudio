...
const DemoShopContext = createContext<any>(null);

const DemoShopProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <DemoShopContext.Provider value={demoShopContext}>
            {children}
        </DemoShopContext.Provider>
    );
};

// Override useShop hook for demo
export const useShop = () => {
    const context = useContext(DemoShopContext);
    if (!context) {
        throw new Error('useShop must be used within DemoShopProvider');
    }
    return context;
};
        ...
        <DemoShopProvider>
            <div className="min-h-screen bg-brand-black">
                ...
                <div className="container mx-auto py-8 px-4">
                    ...
                    {/* Admin Dashboard with demo context */}
