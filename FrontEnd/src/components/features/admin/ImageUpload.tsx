...
export const ImageUpload: React.FC<ImageUploadProps> = ({ image, onImageChange, label }) => {
  ...
  return (
    <div>
      ...
      <div 
        className={`relative w-full aspect-video bg-brand-dark/30 border-2 border-dashed transition-all flex flex-col items-center justify-center cursor-pointer overflow-hidden group ${
          isDragging ? 'border-brand-bone bg-brand-dark/50' : 'border-brand-dark hover:border-brand-bone'
        }`}
