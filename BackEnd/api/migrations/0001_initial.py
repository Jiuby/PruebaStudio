    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('large', 'Large'), ('medium', 'Medium'), ('small', 'Small')], default='medium', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_email', models.EmailField(default='support@goustty.com', max_length=254)),
                ('currency', models.CharField(default='COP', max_length=10)),
                ('shipping_flat_rate', models.DecimalField(decimal_places=0, default=12000, max_digits=10)),
                ('free_shipping_threshold', models.DecimalField(decimal_places=0, default=200000, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='api.collection')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
