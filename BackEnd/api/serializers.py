...
class ProductSerializer(serializers.ModelSerializer):
    ...
    secondaryImage = serializers.ImageField(
        source="secondary_image", required=False, allow_null=True
    )
...
class StoreSettingsSerializer(serializers.ModelSerializer):
    ...
    shippingFlatRate = serializers.DecimalField(
        source="shipping_flat_rate", max_digits=10, decimal_places=0
    )
    freeShippingThreshold = serializers.DecimalField(
        source="free_shipping_threshold", max_digits=10, decimal_places=0
    )
